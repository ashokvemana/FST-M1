...
public class Activity8_2 {
    public static void main(String[] args) {
        ...
        //Get columns
        List<WebElement> cols = driver.findElements(By.xpath("//table[@id='sortableTable']/thread/tr/th"));
        //Get rows
        ...
        //Sort the table
        driver.findElement(By.xpath("//table[@id='sortableTable']/thread/tr/th[2]")).click();
